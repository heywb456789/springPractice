...
public class QComment extends EntityPathBase<CommentEntity> {
    ...
    private static final long serialVersionUID = 1923129728L;
    ...
    public final EnumPath<CommentEntity.CommentTargetType> targetType = createEnum("targetType", CommentEntity.CommentTargetType.class);
    ...
    public QComment(Class<? extends CommentEntity> type, PathMetadata metadata, PathInits inits) {
