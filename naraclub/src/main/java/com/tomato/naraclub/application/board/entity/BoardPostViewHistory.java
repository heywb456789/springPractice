...
@Entity
@Table(
        name = "t_board_post_view_history",
        indexes = {
                @Index(name = "idx01_t_board_post_view_history_created_at", columnList = "created_at") // 최신순 정렬용
        }
)
@Getter
@Setter
...
@AllArgsConstructor
@Builder
public class BoardPostViewHistory extends Audit {
